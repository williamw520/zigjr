...
const rpc_reg = @import("../rpc/rpc_registry.zig");
...
test "rpc_registry fn0 variants" {
    const alloc = gpa.allocator();
    {
        ...
        try registry.add("fn0_return_value", null, fn0_return_value);
        try registry.add("fn0_return_value_with_err", null, fn0_return_value_with_err);
        try registry.add("fn0_alloc", null, fn0_alloc);
...
test "rpc_registry fn1" {
    const alloc = gpa.allocator();
    {
        ...
        try registry.add("fn1_return_value", null, fn1_return_value);
        try registry.add("fn1_return_value_with_err", null, fn1_return_value_with_err);
        try registry.add("fn1_alloc_with_err", null, fn1_alloc_with_err);
...
test "rpc_registry fn2" {
    const alloc = gpa.allocator();
    {
        ...
        try registry.add("fn2_return_value", null, fn2_return_value);
        try registry.add("fn2_return_value_with_err", null, fn2_return_value_with_err);
        try registry.add("fn2_alloc_with_err", null, fn2_alloc_with_err);
...
test "rpc_registry with context" {
    const alloc = gpa.allocator();
    {
        ...
        try registry.add("ctx.get", &ctx, Ctx.get);
        try registry.add("ctx.fn0", &ctx, Ctx.fn0);
        try registry.add("ctx.fn1", &ctx, Ctx.fn1);
        try registry.add("ctx.fn1_alloc", &ctx, Ctx.fn1_alloc);
...
test "rpc_registry passing in a Value(.object) as a parameter, with a context, parsing the Value to a struct" {
    const alloc = gpa.allocator();
    {
        ...
        try registry.add("ctx.fn_cat_value_ctx", &ctx, Ctx.fn_cat_value_ctx);
...
test "rpc_registry passing in a struct object as a parameter, on a ctx" {
    const alloc = gpa.allocator();
    {
        ...
        try registry.add("fn_cat_struct_ctx", &ctx, Ctx.fn_cat_struct_ctx);
...
test "rpc_registry passing in a struct object as a parameter, on a ctx, with Allocator parameter" {
    const alloc = gpa.allocator();
    {
        ...
        try registry.add("fn_cat_struct_ctx_alloc", &ctx, Ctx.fn_cat_struct_ctx_alloc);
...
test "rpc_registry register standalone functions on standalone object." {
    const alloc = gpa.allocator();
    {
        ...
        try registry.add("fn_standalone_on", &s, fn_standalone_on);
        try registry.add("fn_standalone_off", &s, fn_standalone_off);
        try registry.add("fn_standalone_get", &s, fn_standalone_get);
