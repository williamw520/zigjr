...
pub const RpcDispatcher = struct {
    ...
    pub fn dispatch(self: *const Self, dc: *DispatchCtxImpl) anyerror!DispatchResult {
        var dcp: DispatchCtx = .{ .dc_impl = dc };
    ...
    fn callMethod(self: *const Self, dcp: *DispatchCtx) anyerror!DispatchResult {
    ...
    fn callHook(self: *const Self, dcp: *DispatchCtx, method: []const u8) void {
